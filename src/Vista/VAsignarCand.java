...
public class VAsignarCand extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldBusqProy.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
    ...
    private void jTableListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableListMouseClicked
       ...
       String cargo;
        cargo = model.getValueAt(index, 3).toString();
        String cod=this.jTextFieldBusqProy.getText();
       
       if(id.length()==0)
       {
           Rutinas.Aviso("Fila Vacía", "ERROR");
       }
       else
       {
           this.dispose();
                try {
                    new CPago(id, cargo, cod);
                } catch (SQLException ex) {
                    Logger.getLogger(VAsignarCand.class.getName()).log(Level.SEVERE, null, ex);
                }
